...
class SaboresForm(forms.ModelForm):
    class Meta:
        model = SaboresModel
        fields = ["nome_produto", "descricao_produto", "embalagem_produto", "preco_produto", "fundo_descricao_produto", "mascote_parado_produto", "mascote_dancando_produto", "mascote_letras_produto", "tabela_nutricional_produto", "ingrediente_pendurado_produto", "letra_musica_produto", "titulo_musica_produto", "musica_produto", "barra_produto" ]
        widgets = {
